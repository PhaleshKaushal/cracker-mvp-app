export const KARAOKE_WINDOW_MS = 1200;       // 1.2s stuck → auto-advance 1 word (~50 WPM fallback)
export const IDLE_TIMEOUT_MS = 30000;        // 30s no advance → show motivational screen
